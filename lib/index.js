...
const logger = new koishi_1.Logger('bilibili-videolink-analysis-fork');
exports.name = 'bilibili-videolink-analysis-fork';
exports.inject = {
    optional: ['puppeteer'],
};
exports.usage = `
    ...
    koishi_1.Schema.union([
        ...
        koishi_1.Schema.intersect([
            ...
            koishi_1.Schema.object({
                ...
                BVnumberParsing: koishi_1.Schema.boolean().default(true).description("是否允许根据`独立的BV、AV号`解析视频 `开启后，可以通过视频的BV、AV号解析视频。` <br>  [触发说明见README](https://www.npmjs.com/package/koishi-plugin-bilibili-videolink-analysis-fork)"),
            }).description('基础解析设置'),
            // 视频过滤规则
            koishi_1.Schema.object({
